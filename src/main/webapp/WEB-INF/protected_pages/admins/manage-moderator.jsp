...
<head>
    ...
    <%-- Show auto-refresh meta tag if msg exists, then remove it from session --%>
    ...
    <div id="addModModal" class="modal-overlay ${showModal == true ? 'active' : ''}">
        <div class="modal-box">
            ...
            <div class="modal-body">
                <%-- Include admin form only when showModal is true --%>
    ...
    <aside>
        <section class="admin-aside-outer">
            ...
            <div class="admin-aside-admin-function-outer">
                ...
                <%-- Show Manage Moderators link only if logged-in admin has ADMIN role --%>
                ...
                <div id="admin-logo">
                    <a href="#" class="admin-user-system-outer">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 36 36">
                            ...
                            <path fill="#475569" d="M14.68 14.81a6.76 6.76 0 1 1 6.76-6.75a6.77 6.77 0 0 1-6.76 6.75m0-11.51a4.76 4.76 0 1 0 4.76 4.76a4.76 4.76 0 0 0-4.76-4.76" />
                            <path fill="#475569" d="M16.42 31.68A2.14 2.14 0 0 1 15.8 30H4v-5.78a14.8 14.8 0 0 1 11.09-4.68h.72a2.2 2.2 0 0 1 .62-1.85l.12-.11c-.47 0-1-.06-1.46-.06A16.47 16.47 0 0 0 2.2 23.26a1 1 0 0 0-.2.6V30a2 2 0 0 0 2 2h12.7Z" />
    ...
    <article class="main-footer">
        <main>
            <section class="admin-main-outer">
                ...
                <%-- Show error or success message based on msg content from session --%>
                <c:choose>
                    <c:when test="${fn:contains(sessionScope.msg, 'Failed to create moderator')}">
                        <span class="error-msg">${sessionScope.msg}</span>
                    </c:when>
                    <c:when test="${fn:contains(sessionScope.msg, 'Successfully created new moderator')}">
                ...
                <div class="mm-hero">
                    ...
                    <div class="mm-total-card">
                        ...
                        <%-- Display total count of moderators in the list --%>
                        ...
                        <form action="${pageContext.request.contextPath}/ManageModerator" method="POST" class="mm-add-btn">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                <rect width="24" height="24" fill="none" />
                                <g fill="none" stroke="#005BBF" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                ...
                <div class="mm-table-section">
                    <div class="mm-table-header">
                        ...
                        <div class="mm-table-actions">
                            <%-- Status filter dropdown — pre-selects current filter and resubmits on change --%>
                    ...
                    <div class="mm-table-wrap">
                        <table class="mm-table">
                            ...
                            <tbody>
                                ...
                                <%-- Loop through all moderators in the list --%>
                                <c:forEach var="eachAdmin" items="${admins}">
                                    <tr>
                                        <td><span class="mm-mod-id">#${eachAdmin.adminId}</span></td>
                                        <td>
                                            <div class="mm-mod-info">
                                                <%-- Avatar initials — two initials if name has two parts, one otherwise --%>
                                                <div class="mm-avatar" style="background:#DBEAFE;color:#1E40AF;">
                                                    <c:set var="nameParts" value="${fn:split(eachAdmin.fullName, ' ')}" />
                                                    <c:choose>
                                        ...
                                        <td>
                                            ...
                                            <span class="mm-date">
                                                <fmt:formatDate value="${eachAdmin.createdAt}" pattern="MMM dd, yyyy" />
                                            </span>
                                        </td>
                                        <td>
                                            <div class="mm-actions-cell">
                                                <%-- Show Suspend button if moderator is ACTIVE or INACTIVE --%>
                                                <c:choose>
                                                    <c:when test="${eachAdmin.status == 'ACTIVE' || eachAdmin.status == 'INACTIVE'}">
                                                        <form action="${pageContext.request.contextPath}/ManageModerator" method="POST">
                                                            <input type="hidden" name="adminId" value="${eachAdmin.adminId}">
                                                    ...
                                                    <%-- Show Reinstate button if moderator is SUSPENDED --%>
                                                    <c:otherwise>
                                                        <form action="${pageContext.request.contextPath}/ManageModerator" method="POST">
                                                            <input type="hidden" name="adminId" value="${eachAdmin.adminId}">
                                ...
                                <%-- Show empty state row if no moderators found --%>
