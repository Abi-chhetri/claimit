            ...
            <section class="admin-main-outer">
                ...
                <div class="mr-header">
                    <div class="mr-header-left">
                        <h1 class="mr-title">Manage Reports</h1>
                        <p class="mr-subtitle">Monitor and resolve flagged items, user disputes, and compliance
                            violations across the platform.</p>
                    </div>
                ...
                <div class="mr-info-row">
                    <div class="mr-info-card">
                        <div class="mr-info-icon">&#129351;</div>
                        <p class="mr-info-title">Support Sync</p>
                        <p class="mr-info-text">Direct user inquiries can be forwarded to the moderator channel via the
                            Contact Messages tab.</p>
                    </div>
                    <div class="mr-info-card">
                        <div class="mr-info-icon">&#128737;</div>
                        <p class="mr-info-title">Review Guidelines</p>
                        <p class="mr-info-text">Ensure all resolutions follow the updated Community Terms of Service and
                            Privacy Policy v2.4.</p>
                    </div>
                </div>
