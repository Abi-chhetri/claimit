...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/found_item.css">
<c:if test="${not empty msg or not empty error}">
	<meta http-equiv="refresh"
		content="3;url=${pageContext.request.contextPath}/ReportFoundItem">
</c:if>
</head>
<body>
	<header class="header">
		<div class="header1">
			...
			<nav class="navbar">
				<a href="${pageContext.request.contextPath}/Home">Home</a> <a
					...
					href="${pageContext.request.contextPath}/ReportFoundItem"
					class="active">Report Found Item</a> <a
					href="${pageContext.request.contextPath}/MyClaim">Claims</a> <a
	...
	<main class="container">
		...
		<aside class="sidebar">
			...
			<p class="description">Help reunite someone with their lost
				property. Your detailed report acts as a digital beacon for the
				rightful owner.</p>
			...
			<section class="content">
				...
				<div class="secure">
					...
					<p>We verify claims through specific item details only you and
						the owner would know.</p>
				</div>

				<div class="secure">
					<strong>Location Privacy</strong>
					<p>Exact street address are only shared once a claim is
			...
			<div class="image">
				<img src="${pageContext.request.contextPath}/images/found_item.png"
					alt="lost item image">
			</div>
		</aside>
		<section class="right_side">
			<form method="post"
				action="${pageContext.request.contextPath}/ReportFoundItem"
				...
				<div class="form-group">
					<label for="Item Name">Item Name</label> <input type="text"
						...
						placeholder="eg.Blue Leather Wallet">
				</div>
				...
				<div class="form-group">
					...
					<textarea id="description" name="description" rows="4"
						placeholder="Describe unique markings, brand, color, or condition..."></textarea>
				</div>
				...
				<div class="form-row">
					<div class="form-group">
						<label for="date-found">Date Found</label> <input type="date"
							id="date-found" name="date-found" placeholder="mm/dd/yyyy">
					</div>

					<div class="form-group">
						<label for="location">Location Found</label> <input type="text"
							id="location" name="location_found"
				...
				<div class="upload-area">
					...
					<label for="image-upload" class="browse-btn"> Browse Files
					</label> <input type="file" id="image-upload" name="item_image"
