                    ...
                    <c:choose>
                        <c:when test="${!each.isRead}">
                            ...
                            <div class="row">
                                ...
                                <div class="date">
                                    <fmt:formatDate value="${each.submittedAt}" pattern="MMM dd, yyyy" />
                                    <span><fmt:formatDate value="${each.submittedAt}" pattern="HH:mm a" /></span>
                                </div>
                                ...
                                <div>
                                    <form action="${pageContext.request.contextPath}/ManageContactMessage" method="POST">
                                        <input type="hidden" name="messageId" value="${each.contactMessageId}">
