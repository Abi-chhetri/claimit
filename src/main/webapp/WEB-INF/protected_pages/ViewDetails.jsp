...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/ViewDetailsPage.css">
</head>
    ...
    <main class="main-page">
        ...
        <section class="detail-section">
            ...
            <article class="detail-right">
                ...
                <p class="claim-note">Verification of ownership will be required upon claiming.</p>
        ...
        <section class="nearby-section">
            <div class="nearby-header">
                <div>
                    ...
                    <p class="nearby-subtitle">Maybe these belong to you or someone you know?</p>
                </div>
