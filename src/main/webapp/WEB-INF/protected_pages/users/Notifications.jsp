...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/header-footer.css">
</head>
	...
	<main class="main-page">
		...
		<section class="notifications-header">
			<div class="notifications-title-group">
				...
				<p class="notifications-subtitle">Stay updated on your reported
					items and community matches.</p>
			</div>
		</section>
		...
		<section class="notifications-layout">
			...
			<article class="notifications-content">
				...
				<c:forEach var="each" items="${notification}">

					<article class="notification-item">

						<div class="notif-icon">
							<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
								viewBox="0 0 24 24" fill="#414754">
							<path
						...
						<div class="notif-body">
							...
							<h3 class="notif-title">${each.type}</h3>

							<p class="notif-desc">${each.message}</p>
							...
							<p class="notif-time">
								...
								<fmt:formatDate value="${each.createdAt}"
		...
		<!-- Show view all button when hide is false -->
		<c:if test="${not hide}">
			<div style="text-align: center; margin-top: 24px;">
				<form action="${pageContext.request.contextPath}/Notification"
					method="POST">
					<button type="submit" class="view-older-btn">View All
						Notifications</button>
				</form>
			</div>
		</c:if>
		<!-- Show view less button when hide is true -->
		<c:if test="${hide}">
			<div style="text-align: center; margin-top: 24px;">
				<form action="${pageContext.request.contextPath}/Notification"
					method="GET">
