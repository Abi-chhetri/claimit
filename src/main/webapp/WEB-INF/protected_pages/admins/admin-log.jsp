        ...
        <section class="rightside">
            ...
            <div class="table-container">
                <table>
                    ...
                    <tr>
                        <td><span class="log">#LOG-82910</span></td>
                        <td><span class="avatar blue">JD</span>Jane Doe</td>
                        <td><span class="badge green">CLAIM APPROVED</span></td>
                        <td>Claim #9921</td>
                        <td>Oct 24, 2024 . 14:22</td>
                        <td><a href="#">View</a></td>
                    </tr>

                    <tr>
                        <td><span class="log">#LOG-82909</span></td>
                        <td><span class="avatar orange">MK</span>Marcus King</td>
                        <td><span class="badge red">SUSPENDED</span></td>
                        <td>User: troublemaker99</td>
                        <td>Oct 24, 2024 • 13:05</td>
                        <td><a href="#">View</a></td>
                    </tr>

                    <tr>
                        <td><span class="log">#LOG-82908</span></td>
                        <td><span class="avatar blue">AS</span>Alex Smith</td>
                        <td><span class="badge blue-badge">ITEM RETURNED</span></td>
                        <td>Item #5502 (MacBook Pro)</td>
                        <td>Oct 24, 2024 • 12:45</td>
                        <td><a href="#">View</a></td>
                    </tr>

                    <tr>
                        <td><span class="log">#LOG-829</span></td>
                        <td><span class="avatar blue">JD</span>Jane Doe</td>
                        <td><span class="badge green">CLAIM APPROVED</span></td>
                        <td>Claim #9918 (Car Keys)</td>
                        <td>Oct 24, 2024 . 10:22</td>
                        <td><a href="#">View</a></td>
                    </tr>
                </table>
            </div>
