...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/manage-report.css">
<link rel="stylesheet"
	...
	<article class="main-footer">
		<main>
			<section class="admin-dashboar-nav">
				...
				</span> <span class="no-admin-dashboar-overview"> <a href=""
			...
			<section class="admin-main-outer">
				...
				<div class="mr-header">
					<div class="mr-header-left">
						...
						<p class="mr-subtitle">Approve or reject item submissions
							after review</p>
					</div>
				</div>
				...
				<div class="mr-filter-bar">
					<form action="${pageContext.request.contextPath}/ManageItem"
						method="get" class="mr-filter-form">
						...
						<div class="mr-filter-pill">
							...
							<select name="status" onchange="this.form.submit()">
								...
								<option value="PENDING"
									${statusFilter == 'PENDING'  ? 'selected' : ''}>Pending</option>
								<option value="APPROVED"
									${statusFilter == 'APPROVED' ? 'selected' : ''}>Approved</option>
